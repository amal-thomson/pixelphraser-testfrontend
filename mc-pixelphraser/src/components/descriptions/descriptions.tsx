...
import { fetchSelectedLanguages } from '../../hooks/fetchSelectedLanguages'; // Import fetchSelectedLanguages
...
const Descriptions = () => {
  ...
  const filteredData = descriptionsData?.results.filter((desc) =>
    ...
    selectedLanguages.some((lang) =>
      (desc.value[lang] || "").toLowerCase().includes(searchTerm.toLowerCase())
    )
  ) || [];
      ...
      <Spacings.Stack scale="l">
        ...
        <div style={{ marginBottom: '1.5rem' }}>
          <Text.Body tone="secondary">
            PixelPhraser Application enables you to review and manage AI-generated temporary product descriptions. You can search, view, accept or reject descriptions, and preview associated product images. Accepted descriptions will be applied to the products in the catalog.
          </Text.Body>
        </div>

        <Card>
          <Spacings.Stack scale="m">
            <StatusMessage error={error} successMessage={null} />
